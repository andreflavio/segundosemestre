...
-- Exercício 1: Trigger para atualizar a quantidade de projetos da tbl_departamentos caso um projeto for deletado
...
-- Exercício 2: Trigger para atualizar a quantidade de projetos da tbl_departamentos caso um novo projeto for adicionado
...
-- Exercício 3: a) Crie uma tabela chamada tbl_empregado_historico_salario com as colunas cod_empregado, salario e data
...
-- Criação da tabela tbl_empregado_historico_salario
...
-- Criação da trigger para salvar o salário atual
...
-- Exercício 4: a) Crie uma coluna chamada data_atualizacao na tbl_empregados do tipo TIMESTAMP
--             b) Crie uma trigger que toda vez que os dados do empregado forem atualizados, que essa data tambem seja atualizada

-- Adição da coluna data_atualizacao na tbl_empregados
ALTER TABLE tbl_empregados
ADD COLUMN data_atualizacao TIMESTAMP;

-- Criação da trigger para atualizar a data de atualização
